...
func GithubIssuesFetcher(repoInfo []byte) *domain.IssuesData {
	...
	// Store the data in the issuesData struct
	issuesData.Issues = issuesMap
	issuesData.Owner = owner
	issuesData.Repository = repoName
